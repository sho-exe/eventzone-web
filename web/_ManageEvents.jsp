                ...
                <% Club myClub=(Club) request.getAttribute("club"); if (myClub==null) { %>
                    ...
                    <% } else { %>
                        ...
                        <% String message=request.getParameter("message"); %>
                            <% if (message !=null && !message.trim().isEmpty()) { boolean
                                isError=message.startsWith("Error"); String alertClass=isError ? "alert-danger"
                                : "alert-success" ; String iconClass=isError ? "bx-error-circle" : "bx-check-circle" ;
                                ...
                                <% } %>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1 text-info fw-bold" style="font-size: 0.95rem;">
                                                            Page Guide &
                                                            Tips</h6>
                                                        <div class="text-dark"
                                                            ...
                                                            You are actively managing <strong>
                                                                <%= myClub.getClubName() %>
                                                            </strong>. Submit event proposals here. The Advisor or HEPA
                                                            must
                                    ...
                                    <div
                                        class="d-flex justify-content-between align-items-center mt-4 mb-3 flex-wrap gap-2">
                                        <h5 class="fw-bold text-dark mb-0"><i class="fas fa-list me-2"></i> Club Event
                                            Archive</h5>
                                        <div class="d-flex align-items-center flex-nowrap gap-2">
                                            ...
                                            <button type="button" class="btn btn-primary text-nowrap"
                                                data-bs-toggle="modal" style="font-weight: 1000"
                                                ...
                                                <div class="col-lg-4 col-md-6 manage-event-card-wrapper">
                                                    <div class="card club-card position-relative">
                                                        <% String imgPath=e.getImage(); if (imgPath !=null &&
                                                            !imgPath.trim().isEmpty()) { if
                                                            (!imgPath.startsWith("http://") &&
                                                            !imgPath.startsWith("https://")) {
                                                            imgPath=request.getContextPath() + "/" + imgPath; } } else {
                                                    ...
                                                    <% /* Insert a full-width spacer row after every 3rd card */ if
                                                        (eventIndex % 3==0) { %>
                                                        <div class="col-12" style="margin-bottom: 550px;"></div>
                                                        <% } %>
                                                            <% } } else { %>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <label class="form-label fw-bold">Location /
                                                                    Venue</label>
                                                                <select name="venue" class="form-select border-primary"
                                                                    required>
                                                                    <option value="" disabled selected>Select Venue
                                                                    </option>
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                <label class="form-label fw-bold d-block">Select SDG
                                                                    Goals:</label>
                                                                <div class="row">
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 1" id="sdg1">
                                                                    ...
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 10" id="sdg10">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg10">SDG 10: Reduced
                                                                                Inequalities</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 11" id="sdg11">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg11">SDG 11: Sustainable Cities
                                                                                and
                                                                                Communities</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 12" id="sdg12">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg12">SDG 12: Responsible
                                                                                Consumption and
                                                                                Production</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 13" id="sdg13">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg13">SDG 13: Climate
                                                                                Action</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 14" id="sdg14">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg14">SDG 14: Life Below
                                                                                Water</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-2">
                                                                    ...
                                                                    <div class="col-md-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="sdgGoals"
                                                                                value="SDG 16" id="sdg16">
                                                                            <label class="form-check-label text-dark"
                                                                                for="sdg16">SDG 16: Peace, Justice and
                                                                                Strong
                                                                                Institutions</label>
                                                                        </div>
                                                                    </div>
            ...
            <% } %> <!-- End Else Branch -->
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        // Prevent selecting previous days in propose event date picker
                        var today = new Date().toISOString().split('T')[0];
                        var proposeDateInput = document.querySelector('#proposeEventModal input[name="date"]');
                        if (proposeDateInput) {
                            proposeDateInput.setAttribute('min', today);
                        }
                    });
                </script>