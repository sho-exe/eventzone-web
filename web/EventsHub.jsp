                        ...
                        <div class="flex-grow-1 container-p-y">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h4 class="fw-bold m-0 py-3">
                                    <span class="text-muted fw-light">SERS /</span> Events Hub
                                </h4>
                            </div>
                                ...
                                <ul class="nav nav-tabs nav-fill">
                                    <li class="nav-item">
                                        <a class="nav-link <%= "explore".equals(activeTab) ? "active" : "" %>" href="events?action=browse">
                                            <i class="tf-icons bx bx-compass me-1"></i> Explore Events
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link <%= "registrations".equals(activeTab) ? "active" : "" %>" href="attendances?action=myAttendance">
                                            <i class="tf-icons bx bx-list-check me-1"></i> My Registrations
                                        </a>
                                    </li>

                                    <% if("CHAIRPERSON".equals(role)) { %>
                                    <li class="nav-item">
                                        <a class="nav-link <%= "manage".equals(activeTab) ? "active" : "" %>" href="events?action=manage">
                                            <i class="tf-icons bx bx-briefcase-alt-2 me-1"></i> Manage Club Events
                                        </a>
                                    </li>
                                    <% } %>
                                </ul>
                                
                                <div class="tab-content border-0 shadow-none bg-transparent px-0 py-4">
                                    ...
                                    <% } else if("manage".equals(activeTab) && "CHAIRPERSON".equals(role)) { %>
                                        <div class="tab-pane fade show active">
