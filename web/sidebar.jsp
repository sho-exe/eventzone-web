...
<%
    ...
    String accentColor, accentLight, accentHex, badgeClass, roleName;
    if ("HEPA".equals(role)) {
        accentColor = "#ea5455";
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="Homepage.jsp" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2" style="color: <%= accentColor %>;">EventZone</span>
        </a>
