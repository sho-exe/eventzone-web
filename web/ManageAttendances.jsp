                ...
                <div class="content-wrapper" style="padding: 0px 30px;">
                    <div class="flex-grow-1 container-p-y">
                        <% Event targetEvent = (Event) request.getAttribute("targetEvent"); // Check if today is the event day 
                            boolean isEventDay = targetEvent != null && targetEvent.getDate() != null
                                    && targetEvent.getDate().toString().equals(java.time.LocalDate.now().toString());
                            // QR token for chairperson 
                            String qrToken = targetEvent != null ? java.util.UUID.nameUUIDFromBytes((targetEvent.getEventId() + "SECRET_SERS").getBytes()).toString() : "";
                        ...
                        <div
                            ...
                            <h4 class="mb-0 text-dark fw-bold d-flex align-items-center">
                                <i class="fas fa-clipboard-check text-success me-2"></i> Roster: <%=targetEvent.getEventName()%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <% if (a.getVerifierName() != null) {
                                                            ...
                                                            String vColor = "#6c757d";
                                                            String vLabel = vRole;
                                                            if ("HEPA".equals(vRole)) {
                                                                vColor = "#ea5455";
                                                                vLabel = "HEPA";
                                                            } else if ("ADVISOR".equals(vRole)) {
                                                                vColor = "#28c76f";
                                                                vLabel = "Advisor";
                                                            } else if ("CHAIRPERSON".equals(vRole)) {
                                                                vColor = "#ff9f43";
                                                                vLabel = "Chairperson";
                                                            }%>
