...
<% String role = (String) session.getAttribute("accountType");
    ...
    boolean isHepa = "HEPA_GLOBAL".equals(viewMode);
    boolean isPending = "ADVISOR_PENDING".equals(viewMode);
    boolean isHistory = "ADVISOR_HISTORY".equals(viewMode);
    String title = isHepa ? "Global Event Approvals" : (isPending ? "Pending Club Proposals"
            : "Club Event Ledger");
    String cardTitle = isHepa ? "Master Event Ledger" : (isPending
            ? "Events Pending Your Review" : "All Managed Events");
    String alertClass = isHepa
            ? "alert-danger bg-danger-soft text-dark" : (isPending ? "alert-info bg-info-soft text-dark"
                    : "alert-secondary text-dark");
    String alertIcon = isHepa ? "fa-shield-alt text-danger" : (isPending
            ? "fa-info-circle text-primary" : "fa-book");
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <% List<Event> eventList = (List<Event>) request.getAttribute("adminEventList");
                                                        if (eventList != null
                                                                && !eventList.isEmpty()) {
