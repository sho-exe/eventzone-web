    ...
    <%@page import="com.lab.model.Event" %>
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            <% String role=(String) session.getAttribute("accountType"); String viewMode=(String)
                ...
                : "Club Event Ledger" ); String cardTitle=isHepa ? "Master Event Ledger" : (isPending
                ? "Events Pending Your Review" : "All Managed Events" ); String alertClass=isHepa
                ? "alert-danger bg-danger-soft text-dark" : (isPending ? "alert-info bg-info-soft text-dark"
                : "alert-secondary text-dark" ); String alertIcon=isHepa ? "fa-shield-alt text-danger" : (isPending
                ? "fa-info-circle text-primary" : "fa-book" ); String alertText=isHepa
