<%@page import="java.util.Map" %>
    <%@page import="java.util.List" %>
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            <% String role=(String) session.getAttribute("accountType"); List<Map<String, Object>> meritHistory = (List
                <Map<String, Object>>) request.getAttribute("meritHistory");
                    %>
                                                ...
                                                <div class="flex-grow-1 container-p-y">
                                                    <div
                                                        ...
                                                        <button onclick="window.print()"
                                                            class="btn btn-primary d-flex align-items-center gap-2 no-print"
                                                            style="margin-top: 0 !important; font-weight: 1000;">
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody class="table-border-bottom-0">
                                                                    <% if (meritHistory !=null &&
                                                                        !meritHistory.isEmpty()) { for (Map<String,
                                                                        Object> merit : meritHistory) {
                                                                        %>
                                                                        <tr>
                                                                            <td>
                                                                                <strong>
                                                                            ...
                                                                            <td>
                                                                                <%= merit.get("awardedDate") !=null ?
                                                                                    merit.get("awardedDate").toString().substring(0,
                                                                                    19) : "-" %>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <% } } else { %>
                                                                            <tr>
                                                                                <td colspan="5"
                                                                                    ...
                                                                                    <i
                                                                                        class="fas fa-history fa-3x mb-3 text-light"></i>
                                                                                    <p class="mb-0">No merit records
                                                                                        found.</p>
                                                                                </td>
                                                                            </tr>
                                                                            <% } %>
