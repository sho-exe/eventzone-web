                ...
                <% List<Event> eventCatalog = (List<Event>)
                            ...
                            <div class="card club-card position-relative">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <span class="club-id-badge badge-index mb-0" style="font-size: 0.72rem; font-weight: 700; background: rgba(105, 108, 255, 0.08); color: #696cff; border-radius: 6px; padding: 4px 8px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <% if(!isFull && !e.isAlreadyRegistered()) { %>
                                            <span class="badge bg-success text-white"
                                                ...
                                                <i class="bx bx-check-circle me-1"></i> <%= spotsLeft %> Spots Left!
                                            </span>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <% } else { %>
                                            <% String confirmMsg="Register for " + e.getEventName().replace("'", "\\'") + "?"; %>
                        ...
                        <% } } else { %>
                            <div class="col-12 text-center py-5 text-muted w-100">
                                ...
                                <p>There are currently no approved campus events to sign up for. Check back soon!</p>
                            </div>
                            <% } %>
            </div>
