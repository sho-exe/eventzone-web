                                                ...
                                                <div class="flex-grow-1 container-p-y">
                                                    ...
                                                    <% String message=request.getParameter("message"); %>
                                                        <% if (message !=null && !message.trim().isEmpty()) { boolean
                                                            isError=message.startsWith("Error"); String
                                                            alertClass=isError ? "alert-danger" : "alert-success" ;
                                                            String iconClass=isError ? "bx-error-circle"
                                                            : "bx-check-circle" ; String badgeTextClass=isError
                                                            ...
                                                            <div class="alert <%= alertClass %> border-0 shadow-sm mb-4 alert-dismissible fade show"
                                                                ...
                                                                <%= message%>
                                                                    <% if (!isError) { %>
                                                                        <span
                                                                            class="badge bg-white <%= badgeTextClass %> ms-2 countdown-badge"
                                                                                                ...
                                                                                                <div class="card-inner">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <span
                                                                                                            ...
                                                                                                            style="font-size: 1.05rem !important; padding: 8px 14px !important;">
                                                                                                            <%=
                                                                                                                clubIndex%>
                                                                                                        </span>
                                                                                                        <span
                                                                                                            class="club-id-badge badge-id mb-0"
                                                                                                            style="font-size: 0.9rem !important; padding: 6px 12px !important;">
                                                                                                            ID: <%=
                                                                                                                c.getClubId()%>
                                                                                                        </span>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        ...
                                                                                                        <i class="bx bx-pencil text-muted position-absolute"
                                                                                                            style="right: 4px; top: 8px; font-size: 0.9rem; pointer-events: none;"></i>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <i class="bx bx-pencil text-muted position-absolute"
                                                                                                            style="right: 12px; top: 12px; font-size: 0.85rem; pointer-events: none;"></i>
                                                                                                    </div>
